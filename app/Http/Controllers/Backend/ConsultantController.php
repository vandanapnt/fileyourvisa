...
class ConsultantController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Consultants';

        // module name
        $this->module_name = 'consultants';

        // directory path of the module
        $this->module_path = 'consultants';
    ...
    public function profileUpdate(Request $request, $id)
    {
        ...
        return redirect(route('backend.consultants.profile', $$module_name_singular->id));
    }
    ...
    public function changePassword($id)
    {
        ...
        return view(
            ...
            compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular", 'user')
        );
    }
