        ...
        <div class="row">
            ...
            <div class="col-5">
                <div class="float-right">
                   ...
                   <x-buttons.create route='{{ route("backend.consultants.create") }}' title="{{__('Create')}} {{ ucwords(Str::singular($module_name)) }}" />
                  <!--
                    <div class="btn-group" role="group" aria-label="Toolbar button groups">
                        <div class="btn-group" role="group">
                           ...
                           <div class="dropdown-menu" aria-labelledby="btnGroupToolbar">
                                <a class="dropdown-item" href="{{ route("backend.users.trashed") }}">
